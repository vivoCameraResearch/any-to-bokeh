...
def main():
    ...
    # initialize the weight by pre-train model
    unet.conv_in_mpi.weight.data = unet.conv_in.weight.data.clone()[:,:4,:,:]
    unet.conv_in_mpi.bias.data = unet.conv_in.bias.data.clone()
